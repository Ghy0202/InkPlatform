...
from bert4torch.models import *#bert4torch.model
...
from transformers import T5ForConditionalGeneration, BertTokenizer# 原始版本为MT5ForConditionalGeneration
...
def init_argument():
    ...
    parser.add_argument('--train_data', default='../data/Target/train.tsv')
    parser.add_argument('--dev_data', default='../data/Target/dev.tsv')
    parser.add_argument('--pretrain_model', default='./t5_pegasus_pretrain/chinese_t5_pegasus_small/')
...
if __name__ == '__main__':
    ...
    model = T5ForConditionalGeneration \
                .from_pretrained(args.pretrain_model).to(device)# MT5ForConditionalGeneration
    if args.data_parallel and torch.cuda.is_available():
